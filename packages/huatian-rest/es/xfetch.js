...
export function xfetch(input, init) {
    if (init === void 0) { init = {}; }
    return __awaiter(this, void 0, void 0, function () {
        var resp, _a, success, data, message, message;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    resp = _b.sent();
                    if (!(resp.status >= 200 && resp.status < 300)) return [3 /*break*/, 3];
                ...
                case 5: throw new Error('unhandeld response status.' + resp.status);
            }
        });
    });
}
