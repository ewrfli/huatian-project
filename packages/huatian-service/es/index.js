...
var routes = __importStar(require("./route"));
...
function expressRouterTransfer(fn) {
    var _this = this;
...
function token(req, res, next) {
    ...
    var _a = __read(token.split('-'), 2), _ = _a[0], userId = _a[1];
    var user = domain_1.Repository.userRepo().getByID(userId);
    req.user = user;
    next();
}
